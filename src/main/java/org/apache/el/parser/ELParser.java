...
public class ELParser/*@bgen(jjtree)*/ implements ELParserTreeConstants, ELParserConstants {/*@bgen(jjtree)*/
    ...
    public static int getKindPos(String kind) {
        if (ELParserTokenManager.default_jjmatchedKind.equals(kind)) {
            return 2147483647;
        }
    ...
    public static String getPosKind(int i) {
        return tokenImage[i];
    }


    public static boolean containsKind(String kind) {
        for (int i = 0; i < tokenImage.length; i++) {
            String image = tokenImage[i];
            if (kind.equals(image)) {
                return true;
    ...
    final public void Identifier() throws ParseException {
        ...
        Token t = null;
        try {
            t = jj_consume_token(IDENTIFIER);    // <IDENTIFIER>
            jjtree.closeNodeScope(jjtn000, true);
            jjtc000 = false;
            jjtn000.setImage(t.image);
        } finally {
    ...
    final public void Function() throws ParseException {
        ...
        try {
            if (jj_2_3(2)) {
                t0 = jj_consume_token(IDENTIFIER);  // <IDENTIFIER>
                jj_consume_token(COLON);            // :
            } else {
                ;
            }
            t1 = jj_consume_token(IDENTIFIER);     // <IDENTIFIER>
            if (t0 != null) {
    ...
    private boolean jj_3R_66() {
        if (jj_scan_token(NULL)) return true; // null
        return false;
    }
    ...
    private boolean jj_3R_30() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(GE0)) {           // >=
            jj_scanpos = xsp;
            if (jj_scan_token(GE1)) return true;        // ge
        }
        return false;
    }
    ...
    private boolean jj_3R_29() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(LE0)) {               // <=
            jj_scanpos = xsp;
            if (jj_scan_token(LE1)) return true; // le
        }
        return false;
    }
    ...
    private boolean jj_3R_28() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(GT0)) {           // >
            jj_scanpos = xsp;
            if (jj_scan_token(GT1)) return true; // gt
        }
        return false;
    }
    ...
    private boolean jj_3R_27() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(LT0)) {                       // <
            jj_scanpos = xsp;
            if (jj_scan_token(LT1)) return true;        // lt
        }
        return false;
    }
    ...
    private boolean jj_3R_64() {
        if (jj_scan_token(INTEGER_LITERAL)) return true;        // <INTEGER_LITERAL>
        return false;
    }
    ...
    private boolean jj_3R_24() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(NE0)) {                   // !
            jj_scanpos = xsp;
            if (jj_scan_token(NE1)) return true;    // ne
        }
        return false;
    }

    private boolean jj_3R_63() {
        if (jj_scan_token(FLOATING_POINT_LITERAL)) return true;     // <FLOATING_POINT_LITERAL>
        return false;
    }
    ...
    private boolean jj_3R_23() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(EQ0)) {                       // ==
            jj_scanpos = xsp;
            if (jj_scan_token(EQ1)) return true;        // eq
        }
        return false;
    }
    ...
    private boolean jj_3R_18() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(AND0)) {          // &&
            jj_scanpos = xsp;
            if (jj_scan_token(AND1)) return true;       // and
        }
        return false;
    }
    ...
    private boolean jj_3R_71() {
        if (jj_scan_token(FALSE)) return true;      //false
        return false;
    }
    ...
    private boolean jj_3R_70() {
        if (jj_scan_token(TRUE)) return true;       //true
        return false;
    }
    ...
    private boolean jj_3R_16() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(OR0)) {                   // ||
            jj_scanpos = xsp;
            if (jj_scan_token(OR1)) return true;    // or
        }
        return false;
    }
    ...
    private boolean jj_3R_37() {
        if (jj_scan_token(EMPTY)) return true;          // empty
        if (jj_3R_31()) return true;
        return false;
    }
    ...
    private boolean jj_3R_36() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(NOT0)) {                      // !
            jj_scanpos = xsp;
            if (jj_scan_token(NOT1)) return true;       // not
        }
        if (jj_3R_31()) return true;
        return false;
    }
    ...
    private boolean jj_3R_41() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(MOD0)) {                      // %
            jj_scanpos = xsp;
            if (jj_scan_token(MOD1)) return true;       // mod
        }
        return false;
    }
    ...
    private boolean jj_3R_40() {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_scan_token(DIV0)) {                      // /
            jj_scanpos = xsp;
            if (jj_scan_token(DIV1)) return true;       // div
        }
        return false;
    }
    ...
    private boolean jj_scan_token(String kind) {
    ...
    private void jj_add_error_token(String kind, int pos) {
        ...
        if (pos == jj_endpos + 1) {
            ...
            for (java.util.Iterator<?> it = jj_expentries.iterator(); it.hasNext(); ) {
                String[] oldentry = (String[]) (it.next());
    ...
    public ParseException generateParseException() {
        ...
        if (Utils.eq(jj_kind, "-1")) {
            la1tokens[getKindPos(jj_kind)] = true;
            jj_kind = "-1";
        }
        for (int i = 0; i < 36; i++) {
            if (jj_la1[i] == jj_gen) {
        ...
        for (int i = 0; i < 57; i++) {
            if (la1tokens[i]) {
                jj_expentry = new String[1];
                jj_expentry[0] = getPosKind(i);
                jj_expentries.add(jj_expentry);
            }
        }
        jj_endpos = 0;
        jj_rescan_token();
        jj_add_error_token(EOF, 0);
        String[][] exptokseq = new String[jj_expentries.size()][];
        for (int i = 0; i < jj_expentries.size(); i++) {
            exptokseq[i] = (String[]) jj_expentries.get(i);
        }

        return new ParseException(token, null, tokenImage);
    }
